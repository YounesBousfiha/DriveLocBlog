...
<head>
    ...
    <link href="./pages/assets/css/animations.css" rel="stylesheet">
</head>
...
<body>
        ...
        <nav class="bg-white border-gray-200 dark:bg-gray-900">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
                  <div class="px-4 py-3">
                    <span class="block text-sm text-gray-900 dark:text-white">'. $user['nom']. '</span>
                  ...
                  <ul class="py-2" aria-labelledby="user-menu-button">
                    ...
                    <li>
                      <a href="./pages/actions/auth/logout.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Sign out</a>
                    </li>
                  </ul>
                  </div>';
                        } else {
                    ...
                    <ul
                        ...
                        if($_COOKIE['auth_token']) {
                            ...
                            <a href="pages/myReservation.php"
                               ...
                               echo  '<a href="pages/admin-home.php"
    ...
    <section class="relative bg-blue-900 text-white h-screen flex flex-col justify-center opacity-0 animate-fadeIn">
        <div class="absolute inset-0 bg-cover bg-center"
            style="background-image: url('./pages/assets/img/pexels-pixabay-164634.jpg'); opacity: 0.5;"></div>
        <div class="container mx-auto text-center px-6 relative z-10">
            <h1 class="text-4xl sm:text-5xl md:text-6xl font-bold leading-tight mb-4 opacity-0 animate-fadeInText">
                Rent Your Dream Car Today
            </h1>
            <p class="text-lg sm:text-xl mb-6 opacity-0 animate-fadeInText delay-200">
                Discover a wide selection of cars for all your travel needs. Affordable, reliable, and convenient.
            </p>
            <button
                class="bg-blue-600 text-white px-8 py-3 text-lg rounded-lg hover:bg-blue-700 focus:outline-none transition duration-200 opacity-0 animate-fadeInButton delay-400">
                Explore Our Fleet
            </button>
        </div>
    </section>

    <section class="relative bg-gray-50 text-gray-900 py-20 opacity-0 animate-fadeIn">
        <div class="container mx-auto text-center px-6">
            <h2 class="text-3xl sm:text-4xl font-semibold leading-tight mb-8">
                Available at Major Airports Worldwide
            </h2>
            <p class="text-lg sm:text-xl mb-12">
                Our car rental service is available at major airports worldwide. Arrive and receive your car directly at
                the airport. It’s that easy.
            </p>

            <!-- Service Details -->
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12">
                <div
                    class="bg-white bg-opacity-90 p-8 rounded-lg shadow-lg transform hover:scale-105 hover:shadow-2xl transition duration-300 ease-in-out">
                    <h3 class="text-2xl font-bold mb-4">Quick Pickup</h3>
                    <p class="text-lg">
                        Skip the lines and pick up your car as soon as you arrive at the airport. No waiting, no hassle.
                    </p>
                </div>
                <div
                    class="bg-white bg-opacity-90 p-8 rounded-lg shadow-lg transform hover:scale-105 hover:shadow-2xl transition duration-300 ease-in-out">
                    <h3 class="text-2xl font-bold mb-4">Multiple Locations</h3>
                    <p class="text-lg">
                        We operate in multiple airports worldwide, ensuring you have access to a car wherever you
                        travel.
                    </p>
                </div>
                <div
                    ...
                    <p class="text-lg">
                        Our services are available around the clock, so you can always count on us, no matter when your
                        flight arrives.
                    </p>
                </div>
            </div>
    ...
    <div class="my-6 font-[sans-serif]">
      ...
      <section class="relative bg-blue-900 text-white py-20 opacity-0 animate-fadeInCTA">
        <div class="container mx-auto text-center px-6">
          <h2 class="text-3xl sm:text-4xl font-semibold leading-tight mb-6">
            Ready to Rent Your Dream Car?
          </h2>
          <p class="text-lg sm:text-xl mb-8">
            Get started now by entering your email and exploring our fleet of cars. The best rental experience is just a click away.
          </p>
          ...
          <form class="flex justify-center items-center">
            <input
              ...
              class="px-6 py-3 text-lg rounded-l-lg focus:outline-none"
              required
            />
            <button
              type="submit"
              class="bg-blue-600 text-white px-8 py-3 text-lg rounded-r-lg hover:bg-blue-700 focus:outline-none transition duration-200"
            >
              Get Started
            </button>
          </form>
