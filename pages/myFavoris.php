        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <?php foreach ($favoris as $favori) : ?>
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
                    <img src="https://images.unsplash.com/photo-1612838320302-3b3b3f1b3b3b"
                         class="w-full h-48 object-cover object-center" alt="Article image">
                    <div class="p-6">
                        <h2 class="mb-3 text-lg font-semibold text-gray-900 dark:text-white"><?php echo $favori['article_title']  ?></h2>
                        <p class="text-gray-700 dark:text-gray-300"><?php echo substr($favori['article_content'], 0, 100) . '...'; ?></p>
                        <div class="flex justify-between">
                            <div class="mt-4">
                                <a href="Articles.php?article_id=<?php echo $favori['article_id'] ?>"
                                   class="text-blue-600 hover:underline dark:text-blue-400">Read more</a>
                            </div>
                            <div class="mt-4">
                                <a href="./actions/favori/delete_favori.php?favori_id=<?php echo $favori['favoris_id'] ?>" class="bg-red-500 text-white p-2 rounded-md hover:bg-red-800">remove</a>
                            </div>
                        </div>
                    </div>
                </div>
