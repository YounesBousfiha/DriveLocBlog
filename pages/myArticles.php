...
$allblogs = $userController->GetUserArticle(Validator::ValidateData($userData['user_id']));
?>
...
<div class="w-full mt-6 flex justify-center">
    <div class="w-full h-screen max-w-screen-lg">
        <p class="text-xl pb-3 flex items-center">
            <i class="fas fa-list mr-3"></i> My Articles
        </p>
        <div class="bg-white overflow-auto">
            <table class="min-w-full bg-white">
                <thead class="bg-gray-800 text-white">
                <tr>
                    <th class="w-1/6 text-left py-3 px-4 uppercase font-semibold text-sm">Article Title</th>
                    <th class="w-1/6 text-left py-3 px-4 uppercase font-semibold text-sm">Aricle Image</th>
                    <th class="w-1/6 text-left py-3 px-4 uppercase font-semibold text-sm">Aricle Theme</th>
                    <th class="w-1/6 text-left py-3 px-4 uppercase font-semibold text-sm">Article Status</th>
                ...
                <!-- ...existing rows... -->
                    ...
                    foreach ($allblogs as $blog) {
                        echo Helpers::RenderUserArticles($blog);
                    }
                    ?>
                <!-- ...existing rows... -->
                </tbody>
