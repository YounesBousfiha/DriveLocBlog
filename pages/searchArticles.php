...
<section>
    <div class="container mx-auto p-4">
        <div class="flex justify-between my-4">
            <div>
                <h1 class="text-2xl font-bold mb-4">All Themes</h1>
            </div>
            <div>
                <form class="flex space-x-2" action="searchArticles.php" method="POST">
                    <input type="text" name="search" class="form-input w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none" placeholder="Search Par Titre">
                    <button type="submit" class="bg-blue-500 hover:bg-blue-800 text-white px-2 rounded-md">Search</button>
                </form>
            </div>
        </div>
