...
$allArticles = $adminController->getArticleForAdmin();
...
<div class="w-full flex flex-col h-screen overflow-y-hidden">
    ...
    <header x-data="{ isOpen: false }" class="w-full bg-sidebar py-5 px-6 sm:hidden">
        ...
        <nav :class="isOpen ? 'flex': 'hidden'" class="flex flex-col pt-4">
            ...
            <a href="gestiondesComment.php" class="flex items-center text-white opacity-75 hover:opacity-100 py-2 pl-4 nav-item">
                <i class="fas fa-comment"></i>
                Gestion des Commentaire
            </a>
            <a href="gestiondesArticle.php.php" class="flex items-center text-white opacity-75 hover:opacity-100 py-2 pl-4 nav-item">
                <i class="fas fa-newspaper mr-3"></i>
                Gestion des Aricles
            </a>
    ...
    <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6">
            <h1 class="text-3xl text-black pb-6">Gestion des Articles</h1>
            <div class="w-full mt-6">
                <div class="bg-white overflow-auto">
                    <table class="min-w-full bg-white">
                        <thead class="bg-gray-800 text-white">
                        <tr>
                            <th class="w-1/4 text-left py-3 px-4 uppercase font-semibold text-base"> Article Title</th>
                            <th class="w-1/4 text-left py-3 px-4 uppercase font-semibold text-base"> Article Status </th>
                            <th class="w-1/4 text-left py-3 px-4 uppercase font-semibold text-base">Author Email</th>
                            <th class="w-1/4 text-left py-3 px-4 uppercase font-semibold text-base">Theme</th>
                        ...
                        <!-- ...existing rows... -->
                        <?php
                        foreach ($allArticles as $entrie) {
                            echo Helpers::renderArticlesForAdmin($entrie);
                        }
                        ?>
                        <!-- ...existing rows... -->
                        </tbody>
