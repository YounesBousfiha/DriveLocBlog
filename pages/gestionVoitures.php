    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
            ...
            <main class="w-full flex-grow p-6">
                ...
                <button class="bg-blue-500 text-white px-4 py-2 rounded" @click="isModalOpen = true">Add Car</button>

                <div class="w-full mt-6">
                    <p class="text-xl pb-3 flex items-center">
                        <i class="fas fa-list mr-3"></i> Car List
                    </p>
                    <div class="bg-white overflow-auto">
                        <table class="min-w-full bg-white">
                            <thead class="bg-gray-800 text-white">
                                <tr>
                                    <th class="w-1/4 text-left py-3 px-4 uppercase font-semibold text-sm">Marque</th>
                                    <th class="w-1/4 text-left py-3 px-4 uppercase font-semibold text-sm">Model</th>
                                    <th class="w-1/4 text-left py-3 px-4 uppercase font-semibold text-sm">Prix</th>
                                    <th class="w-1/4 text-left py-3 px-4 uppercase font-semibold text-sm">Disponibilité</th>
