...
$allComments = $adminController->getCommentaireForAdmin();
?>
...
<div class="w-full flex flex-col h-screen overflow-y-hidden">
    ...
    <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6">
            <h1 class="text-3xl text-black pb-6">Gestion des Commentaire</h1>
            <div class="w-full mt-6">
                <div class="bg-white overflow-auto">
                    <table class="min-w-full bg-white">
                        <thead class="bg-gray-800 text-white">
                        <tr>
                            <th class="w-1/4 text-left py-3 px-4 uppercase font-semibold text-base"> Nom</th>
                            <th class="w-1/4 text-left py-3 px-4 uppercase font-semibold text-base"> Prenom </th>
                            <th class="w-1/4 text-left py-3 px-4 uppercase font-semibold text-base">Article Title</th>
                            <th class="w-1/4 text-left py-3 px-4 uppercase font-semibold text-base">Commentaire</th>
                        ...
                        <?php
                            foreach ($allComments as $comment) {
                                echo Helpers::renderCommentsForAdmin($comment);
                            }
                        ?>
                        <!-- ...existing rows... -->
                        </tbody>
